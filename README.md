...
**Phase 0 حتى 11 مكتملة:** تسجيل الشركات، الدخول، الصلاحيات، عزل البيانات، إدارة الأصناف/المجموعات/
...
وتقرير الأرباح (حسب الصنف/العميل/المخزن/الفترة). Phase 12 (باقي التقارير) لم يبدأ بعد.
