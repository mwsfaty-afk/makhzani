...
**Phase 0 حتى 10 مكتملة:** تسجيل الشركات، الدخول، الصلاحيات، عزل البيانات، إدارة الأصناف/المجموعات/
العلامات التجارية/الوحدات/المخازن، محرك حركة المخزون، الموردون والمشتريات، العملاء والمبيعات، مرتجع
المبيعات والمشتريات، التحويلات بين المخازن، الجرد، كشوف حساب العملاء والموردين، وإدارة الخزينة الكاملة
(خزائن متعددة، قبض/صرف مستقل، تحويل بين الخزائن). Phase 11 (التكلفة والأرباح) لم يبدأ بعد.
