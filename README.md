...
**Phase 0 حتى 8 مكتملة:** تسجيل الشركات، الدخول، الصلاحيات، عزل البيانات، إدارة الأصناف/المجموعات/
العلامات التجارية/الوحدات/المخازن، محرك حركة المخزون، الموردون والمشتريات، العملاء والمبيعات، مرتجع
المبيعات والمشتريات، التحويلات بين المخازن، والجرد (يولّد تسوية تلقائية بالاتجاه الصحيح — زيادة أو
نقص — حسب فرق العد الفعلي عن الرصيد الدفتري). Phase 9 (كشوف حساب العملاء والموردين) لم يبدأ بعد.
