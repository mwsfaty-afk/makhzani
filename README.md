...
**Phase 0 حتى 7 مكتملة:** تسجيل الشركات، الدخول، الصلاحيات، عزل البيانات، إدارة الأصناف/المجموعات/
العلامات التجارية/الوحدات/المخازن، محرك حركة المخزون، الموردون والمشتريات، العملاء والمبيعات، مرتجع
المبيعات والمشتريات، والتحويلات بين المخازن (تمنع التحويل لنفس المخزن، وتحافظ على قيمة المخزون
الإجمالية دون زيادة أو نقصان). Phase 8 (الجرد) لم يبدأ بعد.
