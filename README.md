...
**Phase 0 و1 و2 مكتملة:** تسجيل الشركات، الدخول، الصلاحيات، عزل البيانات، وإدارة الأصناف/المجموعات/
العلامات التجارية/الوحدات/المخازن بواجهة احترافية (shadcn/ui + هوية Makhzani). Phase 3 (محرك حركة
المخزون) لم يبدأ بعد.
