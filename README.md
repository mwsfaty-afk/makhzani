...
**Phase 0 و Phase 1 مكتملتان:** تسجيل شركة جديدة، الدخول/الخروج، الأدوار والصلاحيات الافتراضية،
وعزل بيانات الشركات — تم اختباره فعليًا بشركتين منفصلتين. Phase 2 (الأصناف والمخازن) لم يبدأ بعد.
