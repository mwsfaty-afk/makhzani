...
**Phase 0 حتى 4 مكتملة:** تسجيل الشركات، الدخول، الصلاحيات، عزل البيانات، إدارة الأصناف/المجموعات/
العلامات التجارية/الوحدات/المخازن، محرك حركة المخزون (متوسط التكلفة المتحرك)، والموردون والمشتريات
(فاتورة شراء: مسودة → اعتماد يُحدّث المخزون ورصيد المورد والخزينة → إلغاء يعكس الأثر بالكامل).
Phase 5 (المبيعات) لم يبدأ بعد.
