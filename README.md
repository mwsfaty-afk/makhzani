...
**Phase 0 حتى 3 مكتملة:** تسجيل الشركات، الدخول، الصلاحيات، عزل البيانات، إدارة الأصناف/المجموعات/
العلامات التجارية/الوحدات/المخازن، ومحرك حركة المخزون (متوسط التكلفة المتحرك + كارت الصنف + إضافة/صرف
مخزون) — تم التحقق منه رقميًا مطابقًا تمامًا لمثال المواصفات. Phase 4 (المشتريات) لم يبدأ بعد.
