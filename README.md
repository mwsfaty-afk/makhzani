...
**Phase 0 حتى 6 مكتملة:** تسجيل الشركات، الدخول، الصلاحيات، عزل البيانات، إدارة الأصناف/المجموعات/
العلامات التجارية/الوحدات/المخازن، محرك حركة المخزون، الموردون والمشتريات، العملاء والمبيعات، ومرتجع
المبيعات ومرتجع المشتريات (يُنشآن ويُعتمدان مباشرة، ويعكسان أثر المخزون والمديونية بدقة). Phase 7
(التحويلات بين المخازن) لم يبدأ بعد.
