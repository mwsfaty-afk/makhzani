...
**Phase 0 حتى 12 مكتملة:** تسجيل الشركات، الدخول، الصلاحيات، عزل البيانات، إدارة الأصناف/المجموعات/
...
تقرير الأرباح، وتقارير تقييم المخزون/الأصناف تحت حد الطلب/المبيعات/المشتريات (كلها قابلة للتصدير CSV).
Phase 13 (لوحة التحكم) لم يبدأ بعد.
