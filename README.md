...
**Phase 0 حتى 9 مكتملة:** تسجيل الشركات، الدخول، الصلاحيات، عزل البيانات، إدارة الأصناف/المجموعات/
العلامات التجارية/الوحدات/المخازن، محرك حركة المخزون، الموردون والمشتريات، العملاء والمبيعات، مرتجع
المبيعات والمشتريات، التحويلات بين المخازن، الجرد، وكشوف حساب كاملة للعملاء والموردين (مع تحصيل/سداد
مستقل غير مرتبط بفاتورة). Phase 10 (الخزينة) لم يبدأ بعد.
