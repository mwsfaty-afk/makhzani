...
**Phase 0 حتى 14 مكتملة:** تسجيل الشركات، الدخول، الصلاحيات، عزل البيانات، إدارة الأصناف/المجموعات/
...
راجع `/admin/login`. PayTabs محجوزة كواجهة بوابة لاحقة (لم تُفعَّل بعد).
Phase 15 (لوحة أدمن SaaS الكاملة) لم تبدأ بعد.
