...
**Phase 0 حتى 13 مكتملة:** تسجيل الشركات، الدخول، الصلاحيات، عزل البيانات، إدارة الأصناف/المجموعات/
...
ولوحة تحكم رئيسية بمؤشرات أداء حية ورسم بياني تفاعلي للمبيعات والمشتريات (14 يومًا).
Phase 14 (الاشتراكات والدفع) لم تبدأ بعد.
