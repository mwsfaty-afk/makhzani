...
const DESCRIPTION =
  "منصة عربية لإدارة المخزون والمبيعات والمشتريات والعملاء والموردين والخزينة والتقارير من لوحة تحكم واحدة، بصلاحيات دقيقة لكل موظف وعزل كامل لبيانات كل شركة.";
