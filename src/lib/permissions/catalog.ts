...
export const MODULES = [
  ...
  { code: "stock_orders", label: "Stock Orders", labelAr: "أوامر التوريد والصرف" },
...
export const DEFAULT_ROLES = {
  ...
  "Warehouse Manager": [
    ...
    modulePermissionCode("stock_orders", "view"),
    modulePermissionCode("stock_orders", "create"),
    modulePermissionCode("stock_orders", "approve"),
